...
* @returns {number}
*/
__exports.adjust = function(ts) {
    const ret = wasm.adjust(ts);
    return ret >>> 0;
};
...
const WasmNetworkFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wasmnetwork_free(ptr >>> 0));
/**
*/
class WasmNetwork {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(WasmNetwork.prototype);
        obj.__wbg_ptr = ptr;
    ...
    /**
    * @returns {WasmNetwork | undefined}
    */
    static new() {
        const ret = wasm.wasmnetwork_new();
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_addEventListener_543dec6cfdd61f52 = function() { return handleError(function (arg0, arg1, arg2, arg3, arg4) {
